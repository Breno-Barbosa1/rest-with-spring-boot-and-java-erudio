...
public class PdfExporter implements PersonExporter {
    ...
    public Resource ExportPeople(List<PersonDTO> people) throws Exception {
        ...
        if (inputStream == null) {
            throw new RuntimeException("File not found: /templates/people.jrxml");
        }
    ...
    public Resource ExportPerson(PersonDTO person) throws Exception {
        ...
        if (mainTemplateStream == null) {
            throw new RuntimeException("File not found: /templates/person.jrxml");
        }

        InputStream subReportStream = getClass().getResourceAsStream("/templates/books.jrxml");
        if (subReportStream == null) {
            throw new RuntimeException("File not found: /templates/books.jrxml");
        }
